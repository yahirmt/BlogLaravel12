...
<div class="mb-8 flex justify-between items-center">
        <flux:breadcrumbs >
            ...
            <flux:breadcrumbs.item separator="slash">Editar</flux:breadcrumbs.item>
        </flux:breadcrumbs>
    </div>
    ...
    <div class="card">
        ...
        <form action="{{route('admin.categories.update', $category)}}" method="POST">
            ...
            <div>
                <flux:input name="name" label="Categoria" description="Nombre de la categoria" value="{{old('name',$category->name)}}"/>
            </div>
